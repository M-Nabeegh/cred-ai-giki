...
export const EVALUATION_SNAPSHOT_TS_PATH = join(ROOT, "src/lib/scoring/evaluation-snapshot.ts")
...
export function evaluationSnapshotToTs(snapshot) {
  return `// Generated by scripts/train-model.mjs from actual test-split predictions. Do not edit by hand.\nimport type { EvaluationSnapshot } from "./types"\n\nexport const evaluationSnapshot: EvaluationSnapshot = ${JSON.stringify(snapshot, null, 2)}\n`
}
